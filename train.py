...
def _main():
    ...
    if is_tiny_version:
        ...
        with tf.device('/cpu:0'):
            ...
            print('model.input shape', template_model.input_layers)
    else:
    ...
    '''validation_data split by ratio'''
    val_split = 0.15
    ...
    if True:
        print('model inputlayer', model.input_layers)
        '''test the optimizers with adam or sgd'''
        ...
        template_model.save(log_dir+'traffic_model.h5')
